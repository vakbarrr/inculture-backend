        ...
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::set_active('berita.index') }} {{ CMS::set_active('berita.edit') }}"
                aria-haspopup="true"><a href="{{ route('berita.index') }}" class="kt-menu__link "><i
                        ...
                        class="kt-menu__link-text">All Blog</span></a></li>
...
<li class="kt-menu__item  {{ CMS::set_active('pesan') }} " aria-haspopup="true"><a href="{{ route('pesan.index') }}"
    class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
            class="kt-svg-icon">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        </svg></span><span class="kt-menu__link-text">Message</span></a>
</li>
...
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('users') }}" aria-haspopup="true"
    data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
            ...
            </svg></span><span class="kt-menu__link-text">Management Users</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ CMS::set_active('users.index') }}  {{ CMS::set_active('users.edit') }} "
                aria-haspopup="true"><a href="{{ route('users.index') }}" class="kt-menu__link "><i
                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        class="kt-menu__link-text">All user</span></a></li>
        </ul>
    </div>
</li>
...
<li class="kt-menu__item  kt-menu__item--submenu {{ CMS::set_open('setting') }} {{ CMS::set_open('layout') }} {{ CMS::set_open('menu') }} }}"
    aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
            ...
            </svg></span><span class="kt-menu__link-text">Setting</span><i
            class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
